    ...
    <div className="min-h-screen bg-white">
            ...
            >
              ...
              <div className="pt-2 space-y-2">
                <Link to="/login" className="block">
                  <Button variant="outline" className="w-full justify-center border-[#075056] text-[#075056] hover:bg-[#075056] hover:text-white font-medium">
                    Login
                  </Button>
                </Link>
                <Link to="/signup" className="block">
                  <Button className="w-full justify-center bg-[#FF5B04] hover:bg-[#FF5B04]/90 font-semibold text-white">
                    Sign Up
                  </Button>
                </Link>
              </div>
      ...
      <section className="pt-28 pb-24 px-6 bg-gradient-to-b from-white via-[#E4EEF0]/20 to-white relative overflow-hidden">
        ...
        <div className="flex justify-center mt-12 gap-4 relative z-10">
          ...
          <Link to="/signup">
            <Button className="bg-[#FF5B04] hover:bg-[#FF5B04]/90 text-white font-semibold shadow-sm hover:shadow-md transition-all">
